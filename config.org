...
- [[#school--gtd-setup][School & GTD Setup]]
...
- [[#title][${title}]]
- [[#class-specific-searches][Class-Specific Searches]]
...
** Capture Templates
Quick entry for assignments and notes:
#+begin_src emacs-lisp
(after! org
...
(after! org-roam
  ...
  (setq org-roam-capture-templates
        '(("c" "Class Note" plain
           "%?"
           :target (file+head "class/${slug}.org"
                              "#+title: ${title}
#+filetags: :${class}:
#+date: %U
